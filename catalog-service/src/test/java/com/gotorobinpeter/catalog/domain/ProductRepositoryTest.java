...
// @Import(ContainersConfig.class) // if we have another rabbitmq container too in this config file it is unnecessary to
// add that too
@Sql("/test-data.sql")
class ProductRepositoryTest {
    ...
    void shouldGetAllProducts() {
        List<ProductEntity> products = productRepository.findAll(); // this framework built in no need to test
